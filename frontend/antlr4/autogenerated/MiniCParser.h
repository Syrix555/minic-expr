...
public:
  ...
  enum {
    ...
    RuleInitVal = 26, RuleIfStmt = 27, RuleWhileStmt = 28, RuleBreakStmt = 29, 
    RuleContinueStmt = 30, RuleUnaryExp = 31, RuleUnaryOp = 32, RulePrimaryExp = 33, 
    RuleRealParamList = 34, RuleLVal = 35
  };
